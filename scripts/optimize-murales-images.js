...
// Directorios - apuntando al proyecto murales
const SOURCE_DIR = '/mnt/c/coding/murales/web/src/assets/images/murals';
const OUTPUT_BASE_DIR = '/mnt/c/coding/murales/web/public/images/optimized';
...
async function processAllImages() {
  console.log('🚀 Iniciando optimización de imágenes del proyecto MURALES...\n');
  ...
  console.log('\n' + '='.repeat(60));
  console.log('📊 RESUMEN DE OPTIMIZACIÓN - PROYECTO MURALES');
